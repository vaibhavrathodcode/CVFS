...
void man(char *name)
{
	...
	if(strcmp(name,"create")==0)
	{
		...
		printf("Usage:create file_nmae permission\n");
	}
	else if(strcmp(name,"raed")==0)
	{
	...
	else if(strcmp(name,"lseek")==0)
	{
		...
		printf("usgae:lseek file_name changeinoffset startpoint\n");
	}
...
void DisplayHelp()
{
	...
	printf("closeall:to closeall the files\n");
...
int CreateFile(char *name,int permission)
{
	...
	UFDTArr[i].ptrfiletable->ptrinode->FyleType=REGULAR;
...
int main()
{
	...
	while(1)
	{
		...
		else if(Count==2)
		{
			...
			{
				ret=CloseFileByName(atoi(command[1]));
              ...
              if(ret==-1)
				  ...
				  else
				  {
		           ...
		           else if(strcmp(command[0],"read")==0)
		           {
		           	...
		           	if(fd==-1)
		           	{
		           		printf("Error:Incorrecy parameter\n");
		           		continue;
		           	}
